                ...
                <div class="col-12">   
                    <form role="form" action="EditProfile" method = "post" enctype='multipart/form-data'>
                        <div class="col-12 mb-3">
                            <input name="email" type="text" class="form-control" placeholder="Current Email">
                        </div>

                        <div class="col-12 mb-3">
                            <input name="newNumber" type="text" class="form-control" placeholder=" Change Mobile Number">
                        </div>

                        <div class="col-12 mb-3">
                            <input name="photo" type="file" class="form-control" placeholder=" Change Mobile Number">
                        </div>
