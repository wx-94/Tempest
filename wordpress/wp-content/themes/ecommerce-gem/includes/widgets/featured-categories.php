				        	...
				        	if( !empty( $term_details ) ){
				        		...
				        		<li class="product-cat product">
				        			...
				        			<div class="product-info-wrap">
				        				<a href="<?php echo esc_url( $term_link ); ?>"><h2 class="featured-cat-title"><?php echo esc_html( $term_title ); ?><?php if( 1 === $show_counts ){ ?><span class="count"><?php echo ' ('.absint( $term_details->count ).')'; ?></span><?php } ?></h2></a>
				        			</div>
				        		</li>
