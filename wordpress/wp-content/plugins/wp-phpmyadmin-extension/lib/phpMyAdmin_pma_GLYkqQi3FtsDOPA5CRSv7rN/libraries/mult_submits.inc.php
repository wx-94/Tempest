...
if (! empty($submit_mult)
    && $submit_mult != __PMA_TRANSL('With selected:')
...
if (!empty($submit_mult) && !empty($what)) {
...
} elseif (! empty($mult_btn) && $mult_btn == __PMA_TRANSL('Yes')) {
    /**
    ...
    if (isset($submit_mult)
        ...
        if (isset($centralColsError) && $centralColsError !== true) {
            ...
            $message = Message::success(__PMA_TRANSL('Success!'));
        }
    } else {
        $message = Message::success(__PMA_TRANSL('No change'));
    }
}
