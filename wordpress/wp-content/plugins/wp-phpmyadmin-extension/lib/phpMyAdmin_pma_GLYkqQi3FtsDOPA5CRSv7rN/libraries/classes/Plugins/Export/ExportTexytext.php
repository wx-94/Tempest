...
class ExportTexytext extends ExportPlugin
{
    ...
    public function exportDBHeader($db, $db_alias = '')
    {
        ...
        return Export::outputHandler(
            '===' . __PMA_TRANSL('Database') . ' ' . $db_alias . "\n\n"
        );
    }
    ...
    public function exportData(
        ...
        if (!Export::outputHandler(
            '== ' . __PMA_TRANSL('Dumping data for table') . ' ' . $table_alias . "\n\n"
        )
        ) {
            return false;
        }
    ...
    public function getTableDef(
        ...
        $text_output .= "|------\n";
        $text_output .= '|' . __PMA_TRANSL('Column');
        $text_output .= '|' . __PMA_TRANSL('Type');
        $text_output .= '|' . __PMA_TRANSL('Null');
        $text_output .= '|' . __PMA_TRANSL('Default');
        if ($do_relation && $have_rel) {
            $text_output .= '|' . __PMA_TRANSL('Links to');
        }
        if ($do_comments) {
            $text_output .= '|' . __PMA_TRANSL('Comments');
    ...
    {
        $dump = "|------\n";
        $dump .= '|' . __PMA_TRANSL('Name');
        $dump .= '|' . __PMA_TRANSL('Time');
        $dump .= '|' . __PMA_TRANSL('Event');
        $dump .= '|' . __PMA_TRANSL('Definition');
        $dump .= "\n|------\n";
    ...
    public function exportStructure(
        ...
        switch ($export_mode) {
        case 'create_table':
            $dump .= '== ' . __PMA_TRANSL('Table structure for table') . ' '
                . $table_alias . "\n\n";
        ...
        case 'triggers':
            ...
            $triggers = $GLOBALS['dbi']->getTriggers($db, $table);
            if ($triggers) {
                $dump .= '== ' . __PMA_TRANSL('Triggers') . ' ' . $table_alias . "\n\n";
                $dump .= $this->getTriggers($db, $table);
            }
            break;
        case 'create_view':
            $dump .= '== ' . __PMA_TRANSL('Structure for view') . ' ' . $table_alias . "\n\n";
            $dump .= $this->getTableDef(
                $db,
                $table,
                $crlf,
            ...
            break;
        case 'stand_in':
            $dump .= '== ' . __PMA_TRANSL('Stand-in structure for view')
                . ' ' . $table . "\n\n";
