...
class ExportLatex extends ExportPlugin
{
    ...
    protected function initSpecificVariables()
    {
        ...
        $GLOBALS['strLatexContent'] = __PMA_TRANSL('Content of table @TABLE@');
        $GLOBALS['strLatexContinued'] = __PMA_TRANSL('(continued)');
        $GLOBALS['strLatexStructure'] = __PMA_TRANSL('Structure of table @TABLE@');
    }
    ...
    protected function setProperties()
    {
        ...
        $leaf = new BoolPropertyItem(
            "caption",
            __PMA_TRANSL('Include table caption')
        );
        ...
        $dumpWhat = new OptionsPropertyMainGroup(
            "dump_what", __PMA_TRANSL('Dump table')
        );
        // create primary items and add them to the group
        ...
        if (!$hide_structure) {
            ...
            $leaf = new TextPropertyItem(
                "structure_caption",
                __PMA_TRANSL('Table caption:')
            );
            $leaf->setDoc('faq6-27');
            $structureOptions->addProperty($leaf);
            $leaf = new TextPropertyItem(
                "structure_continued_caption",
                __PMA_TRANSL('Table caption (continued):')
            );
            $leaf->setDoc('faq6-27');
            $structureOptions->addProperty($leaf);
            $leaf = new TextPropertyItem(
                "structure_label",
                __PMA_TRANSL('Label key:')
            );
            $leaf->setDoc('faq6-27');
            $structureOptions->addProperty($leaf);
        ...
        $dataOptions = new OptionsPropertyMainGroup(
            "data", __PMA_TRANSL('Data dump options')
        );
    ...
    public function exportHeader()
    {
        ...
        $head = '% phpMyAdmin LaTeX Dump' . $crlf
            ...
            . '%' . $crlf
            . '% ' . __PMA_TRANSL('Host:') . ' ' . $cfg['Server']['host'];
        ...
        $head .= $crlf
            ...
            . '% ' . __PMA_TRANSL('Server version:') . ' ' . $GLOBALS['dbi']->getVersionString() . $crlf
            . '% ' . __PMA_TRANSL('PHP Version:') . ' ' . phpversion() . $crlf;
    ...
    public function exportDBHeader($db, $db_alias = '')
    {
        ...
        global $crlf;
        $head = '% ' . $crlf
            . '% ' . __PMA_TRANSL('Database:') . ' ' . '\'' . $db_alias . '\'' . $crlf
            . '% ' . $crlf;
    ...
    public function exportData(
        ...
        $buffer = $crlf . '%' . $crlf . '% ' . __PMA_TRANSL('Data:') . ' ' . $table_alias
    ...
    public function exportStructure(
         ...
         */
        $buffer = $crlf . '%' . $crlf . '% ' . __PMA_TRANSL('Structure:') . ' '
        ...
        $header = ' \\hline ';
        $header .= '\\multicolumn{1}{|c|}{\\textbf{' . __PMA_TRANSL('Column')
            . '}} & \\multicolumn{1}{|c|}{\\textbf{' . __PMA_TRANSL('Type')
            . '}} & \\multicolumn{1}{|c|}{\\textbf{' . __PMA_TRANSL('Null')
            . '}} & \\multicolumn{1}{|c|}{\\textbf{' . __PMA_TRANSL('Default') . '}}';
        if ($do_relation && $have_rel) {
            $header .= ' & \\multicolumn{1}{|c|}{\\textbf{' . __PMA_TRANSL('Links to') . '}}';
        }
        if ($do_comments) {
            $header .= ' & \\multicolumn{1}{|c|}{\\textbf{' . __PMA_TRANSL('Comments') . '}}';
        ...
        foreach ($fields as $row) {
            ...
            $local_buffer = $col_as . "\000" . $type . "\000"
                . (($row['Null'] == '' || $row['Null'] == 'NO')
                    ? __PMA_TRANSL('No') : __PMA_TRANSL('Yes'))
