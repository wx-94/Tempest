...
class TableStructureController extends TableController
{
    ...
    public function indexAction()
    {
        ...
        if (! empty($submit_mult)) {
            if (isset($_REQUEST['selected_fld'])) {
                ...
                $this->response->setRequestStatus(false);
                $this->response->addJSON('message', __PMA_TRANSL('No column selected.'));
            }
        }
    ...
    protected function moveColumns()
    {
        ...
        if ($tmp_error) {
            ...
            $message = Message::success(
                __PMA_TRANSL('The columns have been moved successfully.')
            );
        ...
        for ($i = 0; $i < $selected_cnt; $i++) {
            ...
            if (count($value) == 0) {
                $message = Message::error(
                    __PMA_TRANSL('Failed to get description of column %s!')
                );
    ...
    protected function updatePartitioning()
    {
        ...
        if ($result !== false) {
            $message = Message::success(
                __PMA_TRANSL('Table %1$s has been altered successfully.')
            );
            ...
            $this->response->addJSON(
                'message',
                Message::rawError(
                    __PMA_TRANSL('Query error') . ':<br />' . $this->dbi->getError()
                )
            );
        }
    }
    ...
    protected function getMultipleFieldCommandType()
    {
        ...
        if (isset($_REQUEST['submit_mult'])) {
            ...
            && $_REQUEST['mult_btn'] == __PMA_TRANSL('Yes')
        ) {
        ...
        if (count($changes) > 0 || isset($_REQUEST['preview_sql'])) {
            ...
            if ($result !== false) {
                ...
                $this->response->addJSON(
                    'message',
                    Message::rawError(
                        __PMA_TRANSL('Query error') . ':<br />' . $orig_error
                    )
                );
                $regenerate = true;
            }
    ...
    protected function displayStructure(
        ...
        $titles = array(
            'Change' => Util::getIcon('b_edit', __PMA_TRANSL('Change')),
            'Drop' => Util::getIcon('b_drop', __PMA_TRANSL('Drop')),
            'NoDrop' => Util::getIcon('b_drop', __PMA_TRANSL('Drop')),
            'Primary' => Util::getIcon('b_primary', __PMA_TRANSL('Primary')),
            'Index' => Util::getIcon('b_index', __PMA_TRANSL('Index')),
            'Unique' => Util::getIcon('b_unique', __PMA_TRANSL('Unique')),
            'Spatial' => Util::getIcon('b_spatial', __PMA_TRANSL('Spatial')),
            'IdxFulltext' => Util::getIcon('b_ftext', __PMA_TRANSL('Fulltext')),
            'NoPrimary' => Util::getIcon('bd_primary', __PMA_TRANSL('Primary')),
            'NoIndex' => Util::getIcon('bd_index', __PMA_TRANSL('Index')),
            'NoUnique' => Util::getIcon('bd_unique', __PMA_TRANSL('Unique')),
            'NoSpatial' => Util::getIcon('bd_spatial', __PMA_TRANSL('Spatial')),
            'NoIdxFulltext' => Util::getIcon('bd_ftext', __PMA_TRANSL('Fulltext')),
            'DistinctValues' => Util::getIcon('b_browse', __PMA_TRANSL('Distinct values')),
        );
