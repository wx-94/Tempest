...
class ThemeManager
{
    ...
    public function __construct()
    {
        ...
        if (! $this->checkTheme($GLOBALS['cfg']['ThemeDefault'])) {
            trigger_error(
                sprintf(
                    __PMA_TRANSL('Default theme %s not found!'),
    ...
    public function setActiveTheme($theme = null)
    {
        if (! $this->checkTheme($theme)) {
            trigger_error(
                sprintf(
                    __PMA_TRANSL('Theme %s not found!'),
    ...
    private function _checkThemeFolder($folder)
    {
        if (! is_dir($folder)) {
            trigger_error(
                sprintf(
                    __PMA_TRANSL('Theme path not found for theme %s!'),
    ...
    public function getHtmlSelectBox($form = true)
    {
        ...
        $select_box .=  $theme_preview_href . __PMA_TRANSL('Theme:') . '</a>' . "\n";
