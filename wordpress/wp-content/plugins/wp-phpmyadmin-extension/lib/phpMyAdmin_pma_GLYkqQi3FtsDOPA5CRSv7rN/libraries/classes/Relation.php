...
class Relation
{
    ...
    public function getRelationsParamDiagnostic(array $cfgRelation)
    {
        ...
        $messages['enabled']  = '<span style="color:green">' . __PMA_TRANSL('Enabled') . '</span>';
        $messages['disabled'] = '<span style="color:red">'   . __PMA_TRANSL('Disabled') . '</span>';

        if (strlen($cfgRelation['db']) == 0) {
            $retval .= __PMA_TRANSL('Configuration of pmadb…') . ' '
                 . $messages['error']
                 . Util::showDocu('setup', 'linked-tables')
                 . '<br />' . "\n"
                 . __PMA_TRANSL('General relation features')
                 . ' <font color="green">' . __PMA_TRANSL('Disabled')
                 . '</font>' . "\n";
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Designer and creation of PDFs'),
                'pdfwork',
                $messages
            );
            $retval .= $this->getDiagMessageForParameter(
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Displaying Column Comments'),
                'commwork',
                $messages,
                false
            );
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Browser transformation'),
                'mimework',
                $messages
            );
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Bookmarked SQL query'),
                'bookmarkwork',
                $messages
            );
            $retval .= $this->getDiagMessageForParameter(
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Persistent recently used tables'),
                'recentwork',
                $messages
            );
            $retval .= $this->getDiagMessageForParameter(
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Persistent favorite tables'),
                'favoritework',
                $messages
            );
            $retval .= $this->getDiagMessageForParameter(
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Persistent tables\' UI preferences'),
                'uiprefswork',
                $messages
            );
            $retval .= $this->getDiagMessageForParameter(
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Configurable menus'),
                'menuswork',
                $messages
            );
            $retval .= $this->getDiagMessageForParameter(
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Hide/show navigation items'),
                'navwork',
                $messages
            );
            $retval .= $this->getDiagMessageForParameter(
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Saving Query-By-Example searches'),
                'savedsearcheswork',
                $messages
            );
            $retval .= $this->getDiagMessageForParameter(
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Managing Central list of columns'),
                'centralcolumnswork',
                $messages
            );
            $retval .= $this->getDiagMessageForParameter(
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Remembering Designer Settings'),
            ...
            $retval .= $this->getDiagMessageForFeature(
                __PMA_TRANSL('Saving export templates'),
                'exporttemplateswork',
                $messages
            );
            $retval .= '</table>' . "\n";
            ...
            if (! $cfgRelation['allworks']) {
                ...
                $retval .= '<p>' . __PMA_TRANSL('Quick steps to set up advanced features:')
                    . '</p>';
                ...
                $items[] = __PMA_TRANSL('Create a pma user and give access to these tables.') . ' '
    ...
    public function createPage($newpage, array $cfgRelation, $db)
    {
        if (! isset($newpage) || $newpage == '') {
            $newpage = __PMA_TRANSL('no description');
        }
    ...
    public function getHtmlFixPmaTables($allTables, $createDb = false)
    {
        ...
        if ($allTables) {
            ...
            $message = Message::notice(
                __PMA_TRANSL('%sCreate%s missing phpMyAdmin configuration storage tables.')
            );
        }
