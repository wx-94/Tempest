...
class Search
{
    ...
    public function __construct($db)
    {
        ...
        $this->searchTypes = array(
            '1' => __PMA_TRANSL('at least one of the words'),
            '2' => __PMA_TRANSL('all of the words'),
            '3' => __PMA_TRANSL('the exact phrase as substring'),
            '4' => __PMA_TRANSL('the exact phrase as whole field'),
            '5' => __PMA_TRANSL('as regular expression'),
        );
    ...
    public function getSelectionForm()
    {
        $choices = array(
            '1' => $this->searchTypes[1] . ' '
                . Util::showHint(
                    __PMA_TRANSL('Words are separated by a space character (" ").')
                ),
