...
class Status
{
    ...
    public static function getHtmlForServerStateGeneralInfo(Data $serverStatusData)
    {
        ...
        $retval .= sprintf(
            __PMA_TRANSL('Network traffic since startup: %s'),
            implode(
                ' ',
                Util::formatByteDown(
        ...
        $retval .= '<p>';
        $retval .= sprintf(
            __PMA_TRANSL('This MySQL server has been running for %1$s. It started up on %2$s.'),
    ...
    public static function getHtmlForReplicationInfo()
    {
        ...
        $retval .= __PMA_TRANSL('Replication status');
        $retval .= '</a></h3>';
    ...
    public static function getHtmlForServerStateTraffic(Data $serverStatusData)
    {
        ...
        $retval .= '</th>';
        $retval .= '<th>#</th>';
        $retval .= '<th>&oslash; ' . __PMA_TRANSL('per hour') . '</th>';
        $retval .= '</tr>';
        $retval .= '</thead>';
        $retval .= '<tbody>';
        $retval .= '<tr>';
        $retval .= '<th class="name">' . __PMA_TRANSL('Received') . '</th>';
        ...
        $retval .= '</tr>';
        $retval .= '<tr>';
        $retval .= '<th class="name">' . __PMA_TRANSL('Sent') . '</th>';
        $retval .= '<td class="value">';
        $retval .= implode(
            ' ',
            Util::formatByteDown(
        ...
        $retval .= '</tr>';
        $retval .= '<tr>';
        $retval .= '<th class="name">' . __PMA_TRANSL('Total') . '</th>';
        $retval .= '<td class="value">';
        $bytes_received = $serverStatusData->status['Bytes_received'];
        $bytes_sent = $serverStatusData->status['Bytes_sent'];
        $retval .= implode(
    ...
    public static function getHtmlForServerStateConnections(Data $serverStatusData)
    {
        ...
        $retval .= '<thead>';
        $retval .= '<tr>';
        $retval .= '<th>' . __PMA_TRANSL('Connections') . '</th>';
        $retval .= '<th>#</th>';
        $retval .= '<th>&oslash; ' . __PMA_TRANSL('per hour') . '</th>';
        $retval .= '<th>%</th>';
        $retval .= '</tr>';
        ...
        $retval .= '<tbody>';
        $retval .= '<tr>';
        $retval .= '<th class="name">' . __PMA_TRANSL('Max. concurrent connections') . '</th>';
        $retval .= '<td class="value">';
        ...
        $retval .= '</tr>';
        $retval .= '<tr>';
        $retval .= '<th class="name">' . __PMA_TRANSL('Failed attempts') . '</th>';
        $retval .= '<td class="value">';
        $retval .= Util::formatNumber(
        ...
        $retval .= '</tr>';
        $retval .= '<tr>';
        $retval .= '<th class="name">' . __PMA_TRANSL('Aborted') . '</th>';
        $retval .= '<td class="value">';
        $retval .= Util::formatNumber(
