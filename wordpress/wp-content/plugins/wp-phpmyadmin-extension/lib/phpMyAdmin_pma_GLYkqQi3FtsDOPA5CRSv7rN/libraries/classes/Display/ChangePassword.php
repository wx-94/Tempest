...
class ChangePassword
{
    ...
    public static function getHtml($mode, $username, $hostname)
    {
        ...
        $html .= '<fieldset id="fieldset_change_password">'
            . '<legend'
            . ($is_privileges
                ? ' data-submenu-label="' . __PMA_TRANSL('Change password') . '"'
                : ''
            )
            . '>' . __PMA_TRANSL('Change password') . '</legend>'
            ...
            . 'this.checked = true" />'
            . '<label for="nopass_1">' . __PMA_TRANSL('No Password') . '</label>'
            . '</td>'
            . '</tr>'
            . '<tr class="vmiddle">'
            . '<td>'
            ...
            . 'checked="checked" />'
            . '<label for="nopass_0">' . __PMA_TRANSL('Password:') . '&nbsp;</label>'
            . '</td>'
            . '<td>'
            . __PMA_TRANSL('Enter:') . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp'
        ...
        if (($serverType == 'MySQL'
            ...
            if (($serverType == 'MySQL'
                ...
                $html .= '<tr class="vmiddle">'
                    . '<td>' . __PMA_TRANSL('Password Hashing:') . '</td><td>';
