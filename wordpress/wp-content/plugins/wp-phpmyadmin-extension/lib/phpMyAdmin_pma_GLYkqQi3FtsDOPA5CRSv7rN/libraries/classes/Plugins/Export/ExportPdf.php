...
class ExportPdf extends ExportPlugin
{
    ...
    public function exportData(
        ...
        $pdf->setAttributes($attr);
        $pdf->purpose = __PMA_TRANSL('Dumping data');
    ...
    public function exportStructure(
        ...
        switch ($export_mode) {
        case 'create_table':
            $purpose = __PMA_TRANSL('Table structure');
            break;
        case 'triggers':
            $purpose = __PMA_TRANSL('Triggers');
            break;
        case 'create_view':
            $purpose = __PMA_TRANSL('View structure');
            break;
        case 'stand_in':
            $purpose = __PMA_TRANSL('Stand in');
        } // end switch
