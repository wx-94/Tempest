...
class Header
{
    ...
    public function enablePrintView()
    {
        ...
        $this->setTitle(__PMA_TRANSL('Print view') . ' - phpMyAdmin ' . PMA_VERSION);
            ...
            if (! $this->_isAjax && $this->_isEnabled) {
                ...
                if ($this->_menuEnabled && $GLOBALS['server'] > 0) {
                    ...
                    $retval .= '<span id="page_settings_icon">'
                        . Util::getImage(
                            's_cog',
                            __PMA_TRANSL('Page-related settings')
                        )
                        . '</span>';
                    $retval .= sprintf(
                        ...
                        Util::getImage(
                            's_top',
                            __PMA_TRANSL('Click on the bar to scroll to top of page')
                        )
                    );
                    $retval .= '</span>';
                }
    ...
    private function _getWarnings()
    {
        ...
        if ($this->_warningsEnabled) {
            ...
            $retval .= Message::error(
                __PMA_TRANSL("Javascript must be enabled past this point!")
            )->getDisplay();
            $retval .= "</noscript>";
        }
        return $retval;
