...
class ServerBinlogController extends Controller
{
    ...
    private function _getLogInfo(array $url_params)
    {
        ...
        $html .=  '</td>'
            . '</tr>'
            . '<tr>'
            . '<th>' . __PMA_TRANSL('Log name') . '</th>'
            . '<th>' . __PMA_TRANSL('Position') . '</th>'
            . '<th>' . __PMA_TRANSL('Event type') . '</th>'
            . '<th>' . __PMA_TRANSL('Server ID') . '</th>'
            . '<th>' . __PMA_TRANSL('Original position') . '</th>'
            . '<th>' . __PMA_TRANSL('Information') . '</th>'
            . '</tr>'
            . '</thead>'
            . '<tbody>';
    ...
    private function _getNavigationRow(array $url_params, $pos, $num_rows, $dontlimitchars)
    {
        ...
        if ($dontlimitchars) {
            ...
            $tempTitle = __PMA_TRANSL('Truncate Shown Queries');
            $tempImgMode = 'partial';
        } else {
            $this_url_params['dontlimitchars'] = 1;
            $tempTitle = __PMA_TRANSL('Show Full Queries');
            $tempImgMode = 'full';
        }
