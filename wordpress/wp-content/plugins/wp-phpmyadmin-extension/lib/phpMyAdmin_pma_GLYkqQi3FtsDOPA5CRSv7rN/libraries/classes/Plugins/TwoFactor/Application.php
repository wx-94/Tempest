...
class Application extends TwoFactorPlugin
{
    ...
    {
        return __PMA_TRANSL('Authentication Application (2FA)');
    }
    ...
    {
        return __PMA_TRANSL('Provides authentication using HOTP and TOTP applications such as FreeOTP, Google Authenticator or Authy.');
    }
}
