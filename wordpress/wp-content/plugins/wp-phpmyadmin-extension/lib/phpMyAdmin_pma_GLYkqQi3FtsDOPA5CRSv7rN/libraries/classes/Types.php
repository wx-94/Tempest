...
class Types
{
    ...
    public function getTypeDescription($type)
    {
        ...
        case 'SERIAL':
            return __PMA_TRANSL('An alias for BIGINT UNSIGNED NOT NULL AUTO_INCREMENT UNIQUE');
        case 'DATE':
            return sprintf(
                __PMA_TRANSL('A date, supported range is %1$s to %2$s'), '1000-01-01',
                '9999-12-31'
            );
        case 'DATETIME':
            return sprintf(
                __PMA_TRANSL('A date and time combination, supported range is %1$s to %2$s'),
        ...
        case 'TIME':
            return sprintf(
                __PMA_TRANSL('A time, range is %1$s to %2$s'), '-838:59:59', '838:59:59'
            );
        case 'YEAR':
            return __PMA_TRANSL(
        ...
        case 'SET':
            return __PMA_TRANSL("A single value chosen from a set of up to 64 members");
        case 'GEOMETRY':
            return __PMA_TRANSL('A type that can store a geometry of any type');
        case 'POINT':
            return __PMA_TRANSL('A point in 2-dimensional space');
        case 'LINESTRING':
            return __PMA_TRANSL('A curve with linear interpolation between points');
        case 'POLYGON':
            return __PMA_TRANSL('A polygon');
        case 'MULTIPOINT':
            return __PMA_TRANSL('A collection of points');
        case 'MULTILINESTRING':
            return __PMA_TRANSL(
                'A collection of curves with linear interpolation between points'
            );
        case 'MULTIPOLYGON':
            return __PMA_TRANSL('A collection of polygons');
        case 'GEOMETRYCOLLECTION':
            return __PMA_TRANSL('A collection of geometry objects of any type');
        case 'JSON':
            return __PMA_TRANSL(
