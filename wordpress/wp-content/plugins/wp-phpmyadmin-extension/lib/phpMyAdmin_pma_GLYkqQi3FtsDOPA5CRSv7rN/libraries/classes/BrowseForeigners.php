...
class BrowseForeigners
{
    ...
    public function getHtmlForRelationalFieldSelection(
        ...
        $output .= '<span class="formelement">'
            . '<label for="input_foreign_filter">' . __PMA_TRANSL('Search:') . '</label>'
        ...
        $header = '<tr>
            <th>' . __PMA_TRANSL('Keyname') . '</th>
            <th>' . __PMA_TRANSL('Description') . '</th>
            <td width="20%"></td>
            <th>' . __PMA_TRANSL('Description') . '</th>
            <th>' . __PMA_TRANSL('Keyname') . '</th>
        </tr>';
    ...
    {
        if (isset($foreignShowAll) && $foreignShowAll == __PMA_TRANSL('Show all')) {
            return null;
        }
        isset($_REQUEST['pos']) ? $pos = $_REQUEST['pos'] : $pos = 0;
