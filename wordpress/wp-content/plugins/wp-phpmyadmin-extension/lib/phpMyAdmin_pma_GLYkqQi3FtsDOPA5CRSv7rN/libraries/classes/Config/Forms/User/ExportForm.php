    ...
    public static function getForms()
    {
        return array(
            'Export_defaults' => array(
                'Export/method',
                ':group:' . __PMA_TRANSL('Quick'),
                    'Export/quick_export_onserver',
                    'Export/quick_export_onserver_overwrite',
                    ':group:end',
                ':group:' . __PMA_TRANSL('Custom'),
                    'Export/format',
                    'Export/compression',
                    'Export/charset',
                    'Export/lock_tables',
            ...
            'Csv' => array(
                ':group:' . __PMA_TRANSL('CSV'),
                    ...
                    'Export/csv_columns',
                    ':group:end',
                ':group:' . __PMA_TRANSL('CSV for MS Excel'),
                    'Export/excel_null',
            ...
            'Microsoft_Office' => array(
                ':group:' . __PMA_TRANSL('Microsoft Word 2000'),
                    'Export/htmlword_structure_or_data',
                    'Export/htmlword_null',
                    'Export/htmlword_columns'),
            'Open_Document' => array(
                ':group:' . __PMA_TRANSL('OpenDocument Spreadsheet'),
                    'Export/ods_columns',
                    'Export/ods_null',
                    ':group:end',
                ':group:' . __PMA_TRANSL('OpenDocument Text'),
