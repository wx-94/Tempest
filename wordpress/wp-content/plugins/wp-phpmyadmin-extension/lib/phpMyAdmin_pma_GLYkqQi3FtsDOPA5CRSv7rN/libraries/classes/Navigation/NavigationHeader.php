    ...
    private function _links()
    {
        ...
        if ($GLOBALS['server'] != 0) {
            ...
            if ($GLOBALS['cfg']['Server']['auth_type'] != 'config') {
                $text = __PMA_TRANSL('Log out');
            } else {
                $text = __PMA_TRANSL('Empty session data');
            }
        ...
        $retval .= Util::getNavigationLink(
            ...
            $showText,
            __PMA_TRANSL('phpMyAdmin documentation'),
            $showIcon,
            'b_docs',
            '',
            false,
        ...
        $retval .= Util::getNavigationLink(
            '#',
            $showText,
            __PMA_TRANSL('Navigation panel settings'),
            $showIcon,
            's_cog',
        ...
        $retval .= Util::getNavigationLink(
            '#',
            $showText,
            __PMA_TRANSL('Reload navigation panel'),
            $showIcon,
            's_reload',
