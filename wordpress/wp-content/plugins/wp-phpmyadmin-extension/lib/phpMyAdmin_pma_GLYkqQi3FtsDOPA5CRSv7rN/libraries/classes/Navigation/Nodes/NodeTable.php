...
class NodeTable extends NodeDatabaseChild
{
    ...
    private function _addIcon($page)
    {
        ...
        case 'tbl_structure.php':
            $this->icon[] = Util::getImage('b_props', __PMA_TRANSL('Structure'));
            break;
        case 'tbl_select.php':
            $this->icon[] = Util::getImage('b_search', __PMA_TRANSL('Search'));
            break;
        case 'tbl_change.php':
            $this->icon[] = Util::getImage('b_insrow', __PMA_TRANSL('Insert'));
            break;
        case 'tbl_sql.php':
            $this->icon[] = Util::getImage('b_sql', __PMA_TRANSL('SQL'));
            break;
        case 'sql.php':
            $this->icon[] = Util::getImage('b_browse', __PMA_TRANSL('Browse'));
            break;
        }
    }
}
