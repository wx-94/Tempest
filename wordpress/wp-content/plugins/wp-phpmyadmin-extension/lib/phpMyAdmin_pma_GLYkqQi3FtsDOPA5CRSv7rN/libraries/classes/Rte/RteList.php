...
class RteList
{
    ...
    public static function get($type, array $items)
    {
        ...
        case 'routine':
            ...
            $retval .= "            <th colspan='4'>" . __PMA_TRANSL('Action') . "</th>\n";
            $retval .= "            <th>" . __PMA_TRANSL('Type') . "</th>\n";
            $retval .= "            <th>" . __PMA_TRANSL('Returns') . "</th>\n";
            $retval .= "        </tr>\n";
        ...
        case 'trigger':
            ...
            $retval .= "            <th>" . __PMA_TRANSL('Name') . "</th>\n";
            if (empty($table)) {
                $retval .= "            <th>" . __PMA_TRANSL('Table') . "</th>\n";
            }
            $retval .= "            <th colspan='3'>" . __PMA_TRANSL('Action') . "</th>\n";
            $retval .= "            <th>" . __PMA_TRANSL('Time') . "</th>\n";
            $retval .= "            <th>" . __PMA_TRANSL('Event') . "</th>\n";
            $retval .= "        </tr>\n";
            $retval .= "        <tr class='hide'>\n"; // see comment above
        ...
        case 'event':
            $retval .= "            <th></th>\n";
            $retval .= "            <th>" . __PMA_TRANSL('Name') . "</th>\n";
            $retval .= "            <th>" . __PMA_TRANSL('Status') . "</th>\n";
            $retval .= "            <th colspan='3'>" . __PMA_TRANSL('Action') . "</th>\n";
            $retval .= "            <th>" . __PMA_TRANSL('Type') . "</th>\n";
            $retval .= "        </tr>\n";
            $retval .= "        <tr class='hide'>\n"; // see comment above
        ...
        if (count($items)) {
            ...
            $retval .= Util::getButtonOrImage(
                ...
                __PMA_TRANSL('Export'), 'b_export', 'export'
            );
            $retval .= Util::getButtonOrImage(
                'submit_mult', 'mult_submit',
                __PMA_TRANSL('Drop'), 'b_drop', 'drop'
            );
            $retval .= '</div>';
        }
