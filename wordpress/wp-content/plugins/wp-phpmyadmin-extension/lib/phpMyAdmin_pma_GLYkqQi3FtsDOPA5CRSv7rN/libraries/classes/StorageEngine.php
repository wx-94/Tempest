...
class StorageEngine
{
    ...
    public function getSupportInformationMessage()
    {
        ...
        case PMA_ENGINE_SUPPORT_DEFAULT:
            $message = __PMA_TRANSL('%s is the default storage engine on this MySQL server.');
            break;
        case PMA_ENGINE_SUPPORT_YES:
            $message = __PMA_TRANSL('%s is available on this MySQL server.');
            break;
        case PMA_ENGINE_SUPPORT_DISABLED:
            $message = __PMA_TRANSL('%s has been disabled for this MySQL server.');
            break;
        case PMA_ENGINE_SUPPORT_NO:
        default:
            $message = __PMA_TRANSL(
