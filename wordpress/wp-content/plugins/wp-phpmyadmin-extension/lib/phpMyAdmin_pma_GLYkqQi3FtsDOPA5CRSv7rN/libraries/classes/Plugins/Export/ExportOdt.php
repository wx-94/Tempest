...
class ExportOdt extends ExportPlugin
{
    ...
    protected function setProperties()
    {
        ...
        $dumpWhat = new OptionsPropertyMainGroup(
            "general_opts", __PMA_TRANSL('Dump table')
        );
    ...
    public function exportDBHeader($db, $db_alias = '')
    {
        ...
        $GLOBALS['odt_buffer']
            ...
            . __PMA_TRANSL('Database') . ' ' . htmlspecialchars($db_alias)
            . '</text:h>';
    ...
    public function exportData(
        ...
        $GLOBALS['odt_buffer']
            ...
            . ' text:is-list-header="true">'
            . __PMA_TRANSL('Dumping data for table') . ' ' . htmlspecialchars($table_alias)
            . '</text:h>'
            . '<table:table'
    ...
    public function getTableDefStandIn($db, $view, $crlf, $aliases = array())
    {
        ...
        $GLOBALS['odt_buffer'] .= '<table:table-row>'
            . '<table:table-cell office:value-type="string">'
            . '<text:p>' . __PMA_TRANSL('Column') . '</text:p>'
            . '</table:table-cell>'
            . '<table:table-cell office:value-type="string">'
            . '<text:p>' . __PMA_TRANSL('Type') . '</text:p>'
            . '</table:table-cell>'
            . '<table:table-cell office:value-type="string">'
            . '<text:p>' . __PMA_TRANSL('Null') . '</text:p>'
            . '</table:table-cell>'
            . '<table:table-cell office:value-type="string">'
            . '<text:p>' . __PMA_TRANSL('Default') . '</text:p>'
            . '</table:table-cell>'
            . '</table:table-row>';
    ...
    public function getTableDef(
        ...
        if ($do_relation && $have_rel) {
            $GLOBALS['odt_buffer'] .= '<table:table-cell office:value-type="string">'
                . '<text:p>' . __PMA_TRANSL('Links to') . '</text:p>'
                . '</table:table-cell>';
        }
        if ($do_comments) {
            $GLOBALS['odt_buffer'] .= '<table:table-cell office:value-type="string">'
                . '<text:p>' . __PMA_TRANSL('Comments') . '</text:p>'
                . '</table:table-cell>';
            $comments = $this->relation->getComments($db, $table);
        }
        if ($do_mime && $cfgRelation['mimework']) {
            $GLOBALS['odt_buffer'] .= '<table:table-cell office:value-type="string">'
                . '<text:p>' . __PMA_TRANSL('MIME type') . '</text:p>'
                . '</table:table-cell>';
    ...
    protected function getTriggers($db, $table, array $aliases = array())
    {
        ...
        $GLOBALS['odt_buffer'] .= '<table:table'
            ...
            . '<table:table-row>'
            . '<table:table-cell office:value-type="string">'
            . '<text:p>' . __PMA_TRANSL('Name') . '</text:p>'
            . '</table:table-cell>'
            . '<table:table-cell office:value-type="string">'
            . '<text:p>' . __PMA_TRANSL('Time') . '</text:p>'
            . '</table:table-cell>'
            . '<table:table-cell office:value-type="string">'
            . '<text:p>' . __PMA_TRANSL('Event') . '</text:p>'
            . '</table:table-cell>'
            . '<table:table-cell office:value-type="string">'
            . '<text:p>' . __PMA_TRANSL('Definition') . '</text:p>'
            . '</table:table-cell>'
            . '</table:table-row>';
    ...
    public function exportStructure(
        ...
        case 'create_table':
            $GLOBALS['odt_buffer']
                .= '<text:h text:outline-level="2" text:style-name="Heading_2"'
                . ' text:is-list-header="true">'
                . __PMA_TRANSL('Table structure for table') . ' ' .
        ...
        case 'stand_in':
            $GLOBALS['odt_buffer']
                .= '<text:h text:outline-level="2" text:style-name="Heading_2"'
                . ' text:is-list-header="true">'
                . __PMA_TRANSL('Stand-in structure for view') . ' '
                . htmlspecialchars($table_alias)
                . '</text:h>';
