...
class Data
{
    ...
    private function _getSections()
    {
        return array(
            ...
            'com'           => 'Com',
            'query'         => __PMA_TRANSL('SQL query'),
            'innodb'        => 'InnoDB',
            'ndb'           => 'NDB',
            'handler'       => __PMA_TRANSL('Handler'),
            'qcache'        => __PMA_TRANSL('Query cache'),
            'threads'       => __PMA_TRANSL('Threads'),
            'binlog_cache'  => __PMA_TRANSL('Binary log'),
            'created_tmp'   => __PMA_TRANSL('Temporary data'),
            'delayed'       => __PMA_TRANSL('Delayed inserts'),
            'key'           => __PMA_TRANSL('Key cache'),
            'select'        => __PMA_TRANSL('Joins'),
            'repl'          => __PMA_TRANSL('Replication'),
            'sort'          => __PMA_TRANSL('Sorting'),
            'table'         => __PMA_TRANSL('Tables'),
            'tc'            => __PMA_TRANSL('Transaction coordinator'),
            'files'         => __PMA_TRANSL('Files'),
            'ssl'           => 'SSL',
            'other'         => __PMA_TRANSL('Other')
        );
    }
    ...
    private function _getLinks()
    {
        ...
        $links['table'][__PMA_TRANSL('Flush (close) all tables')] = $this->selfUrl
            . Url::getCommon(
                array(
                    'flush' => 'TABLES'
                )
            );
        $links['table'][__PMA_TRANSL('Show open tables')]
        ...
        if ($GLOBALS['replication_info']['master']['status']) {
            $links['repl'][__PMA_TRANSL('Show slave hosts')]
                = 'sql.php' . Url::getCommon(
                    array(
            ...
            $links['repl'][__PMA_TRANSL('Show master status')] = '#replication_master';
        }
        if ($GLOBALS['replication_info']['slave']['status']) {
            $links['repl'][__PMA_TRANSL('Show slave status')] = '#replication_slave';
        }

        $links['repl']['doc'] = 'replication';

        $links['qcache'][__PMA_TRANSL('Flush query cache')]
            = $this->selfUrl
            . Url::getCommon(
                array(
                    'flush' => 'QUERY CACHE'
        ...
        $links['innodb'][__PMA_TRANSL('Variables')]
            = 'server_engines.php?' . Url::getCommon(array('engine' => 'InnoDB'));
        $links['innodb'][__PMA_TRANSL('InnoDB Status')]
            = 'server_engines.php'
            . Url::getCommon(
                array(
                    'engine' => 'InnoDB',
    ...
    public function getMenuHtml()
    {
        ...
        $items = array(
            array(
                'name' => __PMA_TRANSL('Server'),
                'url' => 'server_status.php'
            ),
            array(
                'name' => __PMA_TRANSL('Processes'),
                'url' => 'server_status_processes.php'
            ),
            array(
                'name' => __PMA_TRANSL('Query statistics'),
                'url' => 'server_status_queries.php'
            ),
            array(
                'name' => __PMA_TRANSL('All status variables'),
                'url' => 'server_status_variables.php'
            ),
            array(
                'name' => __PMA_TRANSL('Monitor'),
                'url' => 'server_status_monitor.php'
            ),
            array(
                'name' => __PMA_TRANSL('Advisor'),
