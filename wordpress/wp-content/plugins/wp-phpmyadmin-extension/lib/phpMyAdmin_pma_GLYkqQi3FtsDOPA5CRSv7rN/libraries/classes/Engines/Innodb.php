...
class Innodb extends StorageEngine
{
    ...
    public function getVariables()
    {
        return array(
            'innodb_data_home_dir'            => array(
                'title' => __PMA_TRANSL('Data home directory'),
                'desc'  => __PMA_TRANSL(
            ...
            'innodb_data_file_path'           => array(
                'title' => __PMA_TRANSL('Data files'),
            ),
            'innodb_autoextend_increment'     => array(
                'title' => __PMA_TRANSL('Autoextend increment'),
                'desc'  => __PMA_TRANSL(
            ...
            'innodb_buffer_pool_size'         => array(
                'title' => __PMA_TRANSL('Buffer pool size'),
                'desc'  => __PMA_TRANSL(
    ...
    public function getInfoPages()
    {
        ...
        $pages = array();
        $pages['Bufferpool'] = __PMA_TRANSL('Buffer Pool');
        $pages['Status'] = __PMA_TRANSL('InnoDB Status');
    ...
    public function getPageBufferpool()
    {
        ...
        $output = '<table class="data" id="table_innodb_bufferpool_usage">' . "\n"
            ...
            . '        ' . __PMA_TRANSL('Buffer Pool Usage') . "\n"
            . '    </caption>' . "\n"
            . '    <tfoot>' . "\n"
            . '        <tr>' . "\n"
            . '            <th colspan="2">' . "\n"
            ...
            . '        </tr>' . "\n"
            . '        <tr>' . "\n"
            . '            <th>' . __PMA_TRANSL('Dirty pages') . '</th>' . "\n"
            . '            <td class="value">'
            . Util::formatNumber(
            ...
            . '        </tr>' . "\n"
            . '        <tr>' . "\n"
            . '            <th>' . __PMA_TRANSL('Pages containing data') . '</th>' . "\n"
            . '            <td class="value">'
            . Util::formatNumber(
            ...
            . '        </tr>' . "\n"
            . '        <tr>' . "\n"
            . '            <th>' . __PMA_TRANSL('Pages to be flushed') . '</th>' . "\n"
            . '            <td class="value">'
            . Util::formatNumber(
        ...
        if (isset($status['Innodb_buffer_pool_pages_latched'])) {
            $output .= '        <tr>'
                . '            <th>' . __PMA_TRANSL('Latched pages') . '</th>'
                . '            <td class="value">'
                . Util::formatNumber(
        ...
        $output .= '    </tbody>' . "\n"
            ...
            . '    <caption class="tblHeaders">' . "\n"
            . '        ' . __PMA_TRANSL('Buffer Pool Activity') . "\n"
            . '    </caption>' . "\n"
            . '    <tbody>' . "\n"
            . '        <tr>' . "\n"
            . '            <th>' . __PMA_TRANSL('Read requests') . '</th>' . "\n"
            . '            <td class="value">'
            . Util::formatNumber(
            ...
            . '        </tr>' . "\n"
            . '        <tr>' . "\n"
            . '            <th>' . __PMA_TRANSL('Write requests') . '</th>' . "\n"
            . '            <td class="value">'
            . Util::formatNumber(
            ...
            . '        </tr>' . "\n"
            . '        <tr>' . "\n"
            . '            <th>' . __PMA_TRANSL('Read misses') . '</th>' . "\n"
            . '            <td class="value">'
            . Util::formatNumber(
            ...
            . '        </tr>' . "\n"
            . '        <tr>' . "\n"
            . '            <th>' . __PMA_TRANSL('Write waits') . '</th>' . "\n"
            . '            <td class="value">'
            . Util::formatNumber(
            ...
            . '        </tr>' . "\n"
            . '        <tr>' . "\n"
            . '            <th>' . __PMA_TRANSL('Read misses in %') . '</th>' . "\n"
            . '            <td class="value">'
            ...
            . '        </tr>' . "\n"
            . '        <tr>' . "\n"
            . '            <th>' . __PMA_TRANSL('Write waits in %') . '</th>' . "\n"
            . '            <td class="value">'
