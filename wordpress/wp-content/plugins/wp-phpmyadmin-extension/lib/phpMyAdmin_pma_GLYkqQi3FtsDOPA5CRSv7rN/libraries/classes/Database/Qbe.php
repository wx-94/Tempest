...
class Qbe
{
    ...
    private function _setCriteriaTablesAndColumns()
    {
        ...
        if (0 == $all_tables_count) {
            Message::error(__PMA_TRANSL('No tables found in database.'))->display();
            exit;
        }
    ...
    private function _getColumnNamesRow()
    {
        ...
        $html_output .= '<th>' . __PMA_TRANSL('Column:') . '</th>';
        $new_column_count = 0;
        for (
            $column_index = 0;
    ...
    {
        $html_output = '<tr class="noclick">';
        $html_output .= '<th>' . __PMA_TRANSL('Alias:') . '</th>';
        $new_column_count = 0;
    ...
    {
        $html_output = '<tr class="noclick">';
        $html_output .= '<th>' . __PMA_TRANSL('Sort:') . '</th>';
        $new_column_count = 0;
    ...
    {
        $html_output = '<tr class="noclick">';
        $html_output .= '<th>' . __PMA_TRANSL('Sort order:') . '</th>';
        $new_column_count = 0;
    ...
    {
        $html_output = '<tr class="noclick">';
        $html_output .= '<th>' . __PMA_TRANSL('Show:') . '</th>';
        $new_column_count = 0;
        for (
            $column_index = 0;
            $column_index < $this->_criteria_column_count;
    ...
    {
        $html_output = '<tr class="noclick">';
        $html_output .= '<th>' . __PMA_TRANSL('Criteria:') . '</th>';
        $new_column_count = 0;
        for (
            $column_index = 0;
            $column_index < $this->_criteria_column_count;
    ...
    private function _getTableFooters()
    {
        ...
        $html_output .= '<input type="submit" name="modify"'
            . ' value="' . __PMA_TRANSL('Update Query') . '" />';
        $html_output .= '</div>';
    ...
    private function _getTablesList()
    {
        ...
        $html_output .= '<fieldset>';
        $html_output .= '<legend>' . __PMA_TRANSL('Use Tables') . '</legend>';
    ...
    {
        $html_output = '<tr class="noclick">';
        $html_output .= '<th>' . __PMA_TRANSL('Modify:') . '</th>';
        $new_column_count = 0;
        for (
        $column_index = 0;
        $column_index < $this->_criteria_column_count;
    ...
    private function _getInsDelAndOrCell($row_index, array $checked_options)
    {
        ...
        $html_output .= '<tr>';
        $html_output .= '<td class="value nowrap">';
        $html_output .= '<small>' . __PMA_TRANSL('Ins:') . '</small>';
        $html_output .= '<input type="checkbox"'
        ...
        $html_output .= '<tr>';
        $html_output .= '<td class="value nowrap">';
        $html_output .= '<small>' . __PMA_TRANSL('Del:') . '</small>';
        $html_output .= '<input type="checkbox"'
    ...
    public function getSelectionForm()
    {
        ...
        $html_output .= '<legend>'
            . sprintf(
                __PMA_TRANSL('SQL query on database <b>%s</b>:'),
        ...
        $html_output .= '<input type="submit" value="' . __PMA_TRANSL('Submit Query') . '" />';
        $html_output .= '</fieldset>';
        $html_output .= '</div>';
        $html_output .= '</form>';
        return $html_output;
    ...
    {
        $html_output = __PMA_TRANSL('Saved bookmarked search:');
        $html_output .= ' <select name="searchId" id="searchId">';
        $html_output .= '<option value="">' . __PMA_TRANSL('New bookmark') . '</option>';
        ...
        $html_output .= '<input type="submit" name="saveSearch" id="saveSearch" '
            . 'value="' . __PMA_TRANSL('Create bookmark') . '" />';
        if (null !== $currentSearchId) {
            $html_output .= '<input type="submit" name="updateSearch" '
                . 'id="updateSearch" value="' . __PMA_TRANSL('Update bookmark') . '" />';
            $html_output .= '<input type="submit" name="deleteSearch" '
                . 'id="deleteSearch" value="' . __PMA_TRANSL('Delete bookmark') . '" />';
        }
