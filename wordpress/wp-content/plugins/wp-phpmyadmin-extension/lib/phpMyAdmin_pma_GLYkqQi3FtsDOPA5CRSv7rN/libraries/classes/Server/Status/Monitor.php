...
class Monitor
{
    ...
    public static function getHtmlForAnalyseDialog()
    {
        ...
        $retval .= __PMA_TRANSL('Log statistics') . '" class="hide">';
        $retval .= '<p>' . __PMA_TRANSL('Selected time range:');
        ...
        $retval .= __PMA_TRANSL('Only retrieve SELECT,INSERT,UPDATE and DELETE Statements');
        $retval .= '</label>';
        $retval .= '<br/>';
        $retval .= '<input type="checkbox" id="removeVariables"'
            . ' value="1" checked="checked" />';
        $retval .= '<label for="removeVariables">';
        $retval .= __PMA_TRANSL('Remove variable data in INSERT statements for better grouping');
        $retval .= '</label>';
        $retval .= '<p>';
        $retval .= __PMA_TRANSL(
        ...
        $retval .= '</p>';
        $retval .= '<p>';
        $retval .= __PMA_TRANSL('Results are grouped by query text.');
        $retval .= '</p>';
        $retval .= '</div>';
        $retval .= '<div id="queryAnalyzerDialog" title="';
        $retval .= __PMA_TRANSL('Query analyzer') . '" class="hide">';
    ...
    public static function getHtmlForInstructionsDialog()
    {
        ...
        $retval .= __PMA_TRANSL('Monitor Instructions') . '" class="hide">';
        $retval .= __PMA_TRANSL(
        ...
        $retval .= ' alt="' . __PMA_TRANSL('Loading…') . '" />';
        $retval .= '<div class="ajaxContent"></div>';
        $retval .= '<div class="monitorUse hide">';
        $retval .= '<p></p>';
        $retval .= '<strong>';
        $retval .= __PMA_TRANSL('Using the monitor:');
        $retval .= '</strong><p>';
        $retval .= __PMA_TRANSL(
        ...
        $retval .= '<strong>';
        $retval .= __PMA_TRANSL('Please note:');
        $retval .= '</strong><br />';
        $retval .= __PMA_TRANSL(
    ...
    public static function getHtmlForAddChartDialog()
    {
        ...
        $retval .= __PMA_TRANSL('Status variable(s)');
        $retval .= '</label><br/>';
        $retval .= '<div id="chartVariableSettings">';
        $retval .= '<label for="chartSeries">' . __PMA_TRANSL('Select series:') . '</label><br />';
        $retval .= '<select id="chartSeries" name="varChartList" size="1">';
        $retval .= '<option>' . __PMA_TRANSL('Commonly monitored') . '</option>';
        ...
        $retval .= __PMA_TRANSL('or type variable name:');
        $retval .= ' </label>';
        ...
        $retval .= __PMA_TRANSL('Display as differential value');
        $retval .= '</label><br />';
        $retval .= '<input type="checkbox" id="useDivisor"'
            . ' name="useDivisor" value="1" />';
        $retval .= '<label for="useDivisor">' . __PMA_TRANSL('Apply a divisor') . '</label>';
        $retval .= '<span class="divisorInput hide">';
        $retval .= '<input type="text" name="valueDivisor" size="4" value="1" />';
        $retval .= '(<a href="#kibDivisor">' . __PMA_TRANSL('KiB') . '</a>, ';
        $retval .= '<a href="#mibDivisor">' . __PMA_TRANSL('MiB') . '</a>)';
        $retval .= '</span><br />';
        $retval .= '<input type="checkbox" id="useUnit" name="useUnit" value="1" />';
        $retval .= '<label for="useUnit">';
        $retval .= __PMA_TRANSL('Append unit to data values');
        $retval .= '</label>';
        $retval .= '<span class="unitInput hide">';
        $retval .= '<input type="text" name="valueUnit" size="4" value="" />';
        $retval .= '</span>';
        $retval .= '<p>';
        $retval .= '<a href="#submitAddSeries"><b>' . __PMA_TRANSL('Add this series') . '</b></a>';
        $retval .= '<span id="clearSeriesLink" class="hide">';
        $retval .= ' | <a href="#submitClearSeries">' . __PMA_TRANSL('Clear series') . '</a>';
        $retval .= '</span>';
        $retval .= '</p>';
        $retval .= __PMA_TRANSL('Series in chart:');
        $retval .= '<br/>';
        $retval .= '<span id="seriesPreview">';
        $retval .= '<i>' . __PMA_TRANSL('None') . '</i>';
        $retval .= '</span>';
        $retval .= '</div>';
        $retval .= '</div>';
        $retval .= '</div>';
    ...
    public static function getHtmlForTabLinks()
    {
        ...
        $retval .= Util::getImage('play') . __PMA_TRANSL('Start Monitor');
        $retval .= '</a>';
        $retval .= '<a href="#settingsPopup" class="popupLink">';
        $retval .= Util::getImage('s_cog') .  __PMA_TRANSL('Settings');
        $retval .= '</a>';
        $retval .= '<a href="#monitorInstructionsDialog">';
        $retval .= Util::getImage('b_help') . __PMA_TRANSL('Instructions/Setup');
        $retval .= '<a href="#endChartEditMode" class="hide">';
        $retval .= Util::getImage('s_okay');
        $retval .= __PMA_TRANSL('Done dragging (rearranging) charts');
        $retval .= '</a>';
        $retval .= '</div>';
    ...
    public static function getHtmlForSettingsDialog()
    {
        ...
        $retval .= '</div>';
        $retval .= '<div class="floatleft">';
        $retval .= __PMA_TRANSL('Chart columns');
        $retval .= '<br />';
        ...
        $retval .= '<b>' . __PMA_TRANSL('Chart arrangement') . '</b> ';
        ...
        $retval .= __PMA_TRANSL('Import');
        $retval .= '</a>';
        $retval .= '&nbsp;&nbsp;';
        $retval .= '<a class="disableAjax" href="#exportMonitorConfig">';
        $retval .= __PMA_TRANSL('Export');
        $retval .= '</a>';
        $retval .= '&nbsp;&nbsp;';
        $retval .= '<a href="#clearMonitorConfig">';
        $retval .= __PMA_TRANSL('Reset to default');
        $retval .= '</a>';
        $retval .= '</div>';
        $retval .= '</div>';
