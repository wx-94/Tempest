...
class ExportHtmlword extends ExportPlugin
{
    ...
    protected function setProperties()
    {
        ...
        $dataOptions = new OptionsPropertyMainGroup(
            "dump_what", __PMA_TRANSL('Data dump options')
        );
    ...
    public function exportDBHeader($db, $db_alias = '')
    {
        ...
        return Export::outputHandler(
            '<h1>' . __PMA_TRANSL('Database') . ' ' . htmlspecialchars($db_alias) . '</h1>'
        );
    }
    ...
    public function getTableDef(
        ...
        if ($do_relation && $have_rel) {
            $schema_insert .= '<td class="print"><strong>'
                . __PMA_TRANSL('Links to')
                . '</strong></td>';
        }
        if ($do_comments) {
            $schema_insert .= '<td class="print"><strong>'
                . __PMA_TRANSL('Comments')
                . '</strong></td>';
    ...
    protected function getTriggers($db, $table)
    {
        ...
        $dump .= '<th class="print">' . __PMA_TRANSL('Name') . '</th>';
        $dump .= '<td class="print"><strong>' . __PMA_TRANSL('Time') . '</strong></td>';
        $dump .= '<td class="print"><strong>' . __PMA_TRANSL('Event') . '</strong></td>';
        $dump .= '<td class="print"><strong>' . __PMA_TRANSL('Definition') . '</strong></td>';
        $dump .= '</tr>';
    ...
    public function exportStructure(
        ...
        case 'triggers':
            ...
            if ($triggers) {
                $dump .= '<h2>'
                    . __PMA_TRANSL('Triggers') . ' ' . htmlspecialchars($table_alias)
                    . '</h2>';
        ...
        case 'create_view':
            $dump .= '<h2>'
                . __PMA_TRANSL('Structure for view') . ' ' . htmlspecialchars($table_alias)
                . '</h2>';
            $dump .= $this->getTableDef(
                $db,
                $table,
