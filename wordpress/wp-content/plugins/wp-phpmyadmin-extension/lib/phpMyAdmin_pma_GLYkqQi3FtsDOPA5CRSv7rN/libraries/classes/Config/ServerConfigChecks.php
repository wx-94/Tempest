        ...
        for ($i = 1; $i <= $serverCnt; $i++) {
            ...
            if ($this->cfg->getValue("Servers/$i/AllowRoot")
                ...
                SetupIndex::messagesSet(
                    ...
                    $title,
                    __PMA_TRANSL('You allow for connecting to the server without a password.')
                    . ' ' . $sSecurityInfoMsg
                );
            }
        }
        ...
        if ($cookieAuthUsed) {
            if ($blowfishSecretSet) {
                ...
                SetupIndex::messagesSet(
                    ...
                    Sanitize::sanitize(__PMA_TRANSL(
