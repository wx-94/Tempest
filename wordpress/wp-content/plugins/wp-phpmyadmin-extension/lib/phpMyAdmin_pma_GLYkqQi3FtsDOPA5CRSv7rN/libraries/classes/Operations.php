...
class Operations
{
    ...
    public function getHtmlForDatabaseComment($db)
    {
        ...
        $html_output .=  __PMA_TRANSL('Database comment');
        $html_output .= '</legend>';
    ...
    public function getHtmlForRenameDatabase($db)
    {
        ...
        $html_output .= __PMA_TRANSL('Rename database to')
            . '</legend>';
        ...
        if ($GLOBALS['db_priv'] && $GLOBALS['table_priv']
            ...
            $html_output .= '<input type="checkbox" name="adjust_privileges" '
                . 'value="1" id="checkbox_adjust_privileges" title="' . __PMA_TRANSL(
        ...
        $html_output .= '<label for="checkbox_adjust_privileges">'
                . __PMA_TRANSL('Adjust privileges') . Util::showDocu('faq', 'faq6-39')
                . '</label><br />';

        $html_output .= ''
            . '</fieldset>'
            . '<fieldset class="tblFooters">'
            . '<input id="rename_db_input" type="submit" value="' . __PMA_TRANSL('Go') . '" />'
            . '</fieldset>'
            . '</form>'
            . '</div>';
    ...
    public function getHtmlForDropDatabaseLink($db)
    {
        ...
        $this_url_params = array(
            ...
            'message_to_show' => sprintf(
                __PMA_TRANSL('Database %s has been dropped.'),
        ...
        $html_output .= __PMA_TRANSL('Remove database')
            . '</legend>';
        $html_output .= '<ul>';
        $html_output .= $this->getDeleteDataOrTablelink(
            $this_url_params,
            'DROP_DATABASE',
            __PMA_TRANSL('Drop the database (DROP)'),
            'drop_db_anchor'
        );
    ...
    public function getHtmlForCopyDatabase($db)
    {
        ...
        $choices = array(
            'structure' => __PMA_TRANSL('Structure only'),
            'data'      => __PMA_TRANSL('Structure and data'),
            'dataonly'  => __PMA_TRANSL('Data only')
        );
        ...
        $html_output .= __PMA_TRANSL('Copy database to')
            . '</legend>'
        ...
        $html_output .= '<label for="checkbox_auto_increment">'
            . __PMA_TRANSL('Add AUTO_INCREMENT value') . '</label><br />';
        ...
        $html_output .= '<label for="checkbox_constraints">'
            . __PMA_TRANSL('Add constraints') . '</label><br />';
        $html_output .= '<br />';
        ...
        if ($GLOBALS['db_priv'] && $GLOBALS['table_priv']
            ...
            $html_output .= '<input type="checkbox" name="adjust_privileges" '
                . 'value="1" id="checkbox_privileges" title="' . __PMA_TRANSL(
                    'You don\'t have sufficient privileges to perform this '
                    . 'operation; Please refer to the documentation for more details'
                )
                . '" disabled/>';
        ...
        $html_output .= '<label for="checkbox_switch">'
            . __PMA_TRANSL('Switch to copied database') . '</label>'
            . '</fieldset>';
        $html_output .= '<fieldset class="tblFooters">'
            . '<input type="submit" name="submit_copy" value="' . __PMA_TRANSL('Go') . '" />'
            . '</fieldset>'
            . '</form>'
            . '</div>';
    ...
    public function getHtmlForChangeDatabaseCharset($db, $table)
    {
        ...
        $html_output .= '<label for="select_db_collation">' . __PMA_TRANSL('Collation')
            . '</label>' . "\n"
            . '</legend>' . "\n"
            ...
            . __PMA_TRANSL('Change all tables collations')
            . '</label>'
            . '<br />'
            ...
            . __PMA_TRANSL('Change all tables columns collations')
            . '</label></span>'
            . '</fieldset>'
            . '<fieldset class="tblFooters">'
            . '<input type="submit" name="submitcollation"'
            . ' value="' . __PMA_TRANSL('Go') . '" />' . "\n"
            . '</fieldset>' . "\n"
            . '</form></div>' . "\n";
    ...
    public function getHtmlForOrderTheTable(array $columns)
    {
        ...
        $html_output .= '<fieldset id="fieldset_table_order">'
            . '<legend>' . __PMA_TRANSL('Alter table order by') . '</legend>'
        ...
        $html_output .= '</select> ' . __PMA_TRANSL('(singly)') . ' '
            . '<br />'
            . '<input id="order_order_asc" name="order_order"'
            . ' type="radio" value="asc" checked="checked" />'
            . '<label for="order_order_asc">' . __PMA_TRANSL('Ascending') . '</label>'
            . '<input id="order_order_desc" name="order_order"'
            . ' type="radio" value="desc" />'
            . '<label for="order_order_desc">' . __PMA_TRANSL('Descending') . '</label>'
            . '</fieldset>'
            . '<fieldset class="tblFooters">'
    ...
    public function getHtmlForMoveTable()
    {
        ...
        $html_output .= '<legend>' . __PMA_TRANSL('Move table to (database<b>.</b>table)')
            . '</legend>';
        ...
        $html_output .= '<input type="checkbox" name="sql_auto_increment" '
            ...
            . __PMA_TRANSL('Add AUTO_INCREMENT value')
            . '</label><br />';
        ...
        if ($GLOBALS['table_priv'] && $GLOBALS['col_priv']
            ...
            $html_output .= '<input type="checkbox" name="adjust_privileges" '
                . 'value="1" id="checkbox_privileges_tables_move" title="' . __PMA_TRANSL(
                    'You don\'t have sufficient privileges to perform this '
                    . 'operation; Please refer to the documentation for more details'
                )
                . '" disabled/>';
        ...
        $html_output .= '</fieldset><fieldset class="tblFooters">'
            . '<input type="submit" name="submit_move" value="' . __PMA_TRANSL('Go') . '" />'
            . '</fieldset>'
            . '</form>'
            . '</div>';
    ...
    {
        $html_output = '<tr><td class="vmiddle">' . __PMA_TRANSL('Rename table to') . '</td>'
            . '<td>'
        ...
        if ($GLOBALS['table_priv'] && $GLOBALS['col_priv']
            ...
            $html_output .= '<input type="checkbox" name="adjust_privileges" '
                . 'value="1" id="checkbox_privileges_table_options" title="' . __PMA_TRANSL(
                    'You don\'t have sufficient privileges to perform this '
                    . 'operation; Please refer to the documentation for more details'
                )
                . '" disabled/>';
        ...
        $html_output .= '<label for="checkbox_privileges_table_options">'
            . __PMA_TRANSL('Adjust privileges') . '&nbsp;'
    ...
    private function getHtmlForTableComments($current_value)
    {
        ...
        $html_output = '<tr><td class="vmiddle">' . __PMA_TRANSL('Table comments') . '</td>'
    ...
    private function getTableOptionFieldset($pma_table, $comment, $tbl_collation,
        ...
        $html_output = '<fieldset>'
            . '<legend>' . __PMA_TRANSL('Table options') . '</legend>';
        ...
        //Storage engine
        $html_output .= '<tr><td class="vmiddle">' . __PMA_TRANSL('Storage Engine')
        ...
        //Table character set
        $html_output .= '<tr><td class="vmiddle">' . __PMA_TRANSL('Collation') . '</td>'
            . '<td>'
            . Charsets::getCollationDropdownBox(
                $GLOBALS['dbi'],
                $GLOBALS['cfg']['Server']['DisableIS'],
        ...
        $html_output .= '<tr><td></td><td>'
            ...
            . __PMA_TRANSL('Change all column collations')
            . '</label>'
            . '</td></tr>';
    ...
    public function getHtmlForCopytable()
    {
        ...
        $html_output .= '<fieldset>';
        $html_output .= '<legend>'
            . __PMA_TRANSL('Copy table to (database<b>.</b>table)') . '</legend>';
        ...
        $html_output .= '<input type="checkbox" name="drop_if_exists" '
            ...
            . sprintf(__PMA_TRANSL('Add %s'), 'DROP TABLE') . '</label><br />'
        ...
        $html_output .= '<input type="checkbox" name="switch_to_new" value="true"'
            ...
            . ($pma_switch_to_new ? ' checked="checked"' : '') . '/>';
        $html_output .= '<label for="checkbox_switch">'
            . __PMA_TRANSL('Switch to copied table') . '</label>'
            . '</fieldset>';
    ...
    public function getHtmlForTableMaintenance($pma_table, array $url_params)
    {
        $html_output = '<div>';
        $html_output .= '<fieldset>'
            . '<legend>' . __PMA_TRANSL('Table maintenance') . '</legend>';
    ...
    private function getListofMaintainActionLink($pma_table, array $url_params)
    {
        ...
        $params = array(
            'sql_query' => 'FLUSH TABLE '
                . Util::backquote($GLOBALS['table']),
            'message_to_show' => sprintf(
                __PMA_TRANSL('Table %s has been flushed.'),
                htmlspecialchars($GLOBALS['table'])
            ),
            'reload' => 1,
        );
        $html_output .= $this->getMaintainActionlink(
            __PMA_TRANSL('Flush the table (FLUSH)'),
            $params,
            $url_params,
            'FLUSH'
        );
    ...
    public function getHtmlForDeleteDataOrTable(
        ...
        $html_output = '<div>'
            . '<fieldset class="caution">'
            . '<legend>' . __PMA_TRANSL('Delete data or table') . '</legend>';
        ...
        if (! empty($truncate_table_url_params)) {
            $html_output .= $this->getDeleteDataOrTablelink(
                ...
                'TRUNCATE_TABLE',
                __PMA_TRANSL('Empty the table (TRUNCATE)'),
                'truncate_tbl_anchor'
            );
        }
        if (!empty($dropTableUrlParams)) {
            $html_output .= $this->getDeleteDataOrTablelink(
                $dropTableUrlParams,
                'DROP_TABLE',
                __PMA_TRANSL('Delete the table (DROP)'),
                'drop_tbl_anchor'
            );
        }
    ...
    {
        $choices = array(
            'ANALYZE' => __PMA_TRANSL('Analyze'),
            'CHECK' => __PMA_TRANSL('Check'),
            'OPTIMIZE' => __PMA_TRANSL('Optimize'),
            'REBUILD' => __PMA_TRANSL('Rebuild'),
            'REPAIR' => __PMA_TRANSL('Repair'),
            'TRUNCATE' => __PMA_TRANSL('Truncate')
        );
        ...
        if ($partition_method == 'RANGE'
            ...
            $choices['DROP'] = __PMA_TRANSL('Drop');
        } else {
            $choices['COALESCE'] = __PMA_TRANSL('Coalesce');
        }
        ...
        $html_output = '<div>'
            ...
            . '<fieldset>'
            . '<legend>'
            . __PMA_TRANSL('Partition maintenance')
        ...
        $html_select .= '</select>' . "\n";
        $html_output .= sprintf(__PMA_TRANSL('Partition %s'), $html_select);
        ...
        $html_output .= '<a href="sql.php'
            ...
            . __PMA_TRANSL('Remove partitioning') . '</a>';
    ...
    public function getHtmlForReferentialIntegrityCheck(array $foreign, array $url_params)
    {
        $html_output = '<div>'
            . '<fieldset>'
            . '<legend>' . __PMA_TRANSL('Check referential integrity:') . '</legend>';
        ...
        if (Core::isValid($_REQUEST['new_name'])) {
            if ($db == $_REQUEST['target_db'] && $table == $_REQUEST['new_name']) {
                if (isset($_REQUEST['submit_move'])) {
                    $message = Message::error(__PMA_TRANSL('Can\'t move table to same one!'));
                } else {
                    $message = Message::error(__PMA_TRANSL('Can\'t copy table to same one!'));
                }
            } else {
                Table::moveCopy(
                ...
                if (isset($_REQUEST['adjust_privileges'])
                    ...
                    if (isset($_REQUEST['submit_move'])) {
                        $message = Message::success(
                            __PMA_TRANSL('Table %s has been moved to %s.')
                        );
                    } else {
                        $message = Message::success(
                            __PMA_TRANSL('Table %s has been copied to %s.')
                        );
                    }
                }
             ...
             */
            $message = Message::error(__PMA_TRANSL('The table name is empty!'));
        }
