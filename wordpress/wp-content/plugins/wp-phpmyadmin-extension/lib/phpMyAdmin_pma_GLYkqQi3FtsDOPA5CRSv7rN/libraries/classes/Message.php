 ...
 *
 * // get special notice
 * $message = Message::notice(__PMA_TRANSL('This is a localized notice'));
 * </code>
 *
...
class Message
{
     ...
     *                       e.g. __PMA_TRANSL('Your SQL query has been
    ...
    {
        if (empty($string)) {
            $string = __PMA_TRANSL('Your SQL query has been executed successfully.');
        }
     ...
     *
     * @param string $string A localized string e.g. __PMA_TRANSL('Error')
     *
     * @return Message
     * @static
     */
     ...
     *
     * @param string $string A localized string
     *                       e.g. __PMA_TRANSL('The additional features for working with
