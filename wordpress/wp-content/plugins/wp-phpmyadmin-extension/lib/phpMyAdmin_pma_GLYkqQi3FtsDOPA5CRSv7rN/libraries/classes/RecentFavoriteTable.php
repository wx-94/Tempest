...
class RecentFavoriteTable
{
    ...
    public function saveToDb()
    {
        ...
        if (! $success) {
            ...
            case 'recent':
                $error_msg = __PMA_TRANSL('Could not save recent table!');
                break;

            case 'favorite':
                $error_msg = __PMA_TRANSL('Could not save favorite table!');
                break;
            }
        ...
        if (count($this->_tables)) {
            if ($this->_tableType == 'recent') {
                ...
                foreach ($this->_tables as $table) {
                    ...
                    $html .= 'href="' . $fav_rm_url
                        . '" title="' . __PMA_TRANSL("Remove from Favorites")
                        . '" data-favtargetn="'
            ...
            $html .= '<li class="warp_link">'
                  . ($this->_tableType == 'recent'
                    ?__PMA_TRANSL('There are no recent tables.')
                    :__PMA_TRANSL('There are no favorite tables.'))
                  . '</li>';
        }
        return $html;
    }
    ...
    public function getHtml()
    {
        ...
        if ($this->_tableType == 'recent') {
            $html .= '<span title="' . __PMA_TRANSL('Recent tables')
                . '" class="drop_button">'
                . __PMA_TRANSL('Recent') . '</span><ul id="pma_recent_list">';
        } else {
            $html .= '<span title="' . __PMA_TRANSL('Favorite tables')
                . '" class="drop_button">'
                . __PMA_TRANSL('Favorites') . '</span><ul id="pma_favorite_list">';
        }
