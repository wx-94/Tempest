...
class File
{
    ...
    public function setUploadedFile($name)
    {
        ...
        if (! $this->isUploaded()) {
            $this->setName(null);
            $this->_error_message = Message::error(__PMA_TRANSL('File was not an uploaded file.'));
            return false;
        }
    ...
    public function setUploadedFromTblChangeRequest($key, $rownumber)
    {
        ...
        case 1: //UPLOAD_ERR_INI_SIZE:
            $this->_error_message = Message::error(__PMA_TRANSL(
        ...
        case 6: //UPLOAD_ERR_NO_TMP_DIR:
            $this->_error_message = Message::error(__PMA_TRANSL('Missing a temporary folder.'));
            break;
        case 7: //UPLOAD_ERR_CANT_WRITE:
            $this->_error_message = Message::error(__PMA_TRANSL('Failed to write file to disk.'));
            break;
        case 8: //UPLOAD_ERR_EXTENSION:
            $this->_error_message = Message::error(__PMA_TRANSL('File upload stopped by extension.'));
            break;
        default:
            $this->_error_message = Message::error(__PMA_TRANSL('Unknown error in file upload.'));
        } // end switch
    ...
    public function setLocalSelectedFile($name)
    {
        ...
        if (@is_link($this->getName())) {
            $this->_error_message = __PMA_TRANSL('File is a symbolic link');
            $this->setName(null);
            return false;
        }
        if (! $this->isReadable()) {
            $this->_error_message = Message::error(__PMA_TRANSL('File could not be read!'));
            $this->setName(null);
            return false;
        }
    ...
    public function checkUploadedFile()
    {
        ...
        if (! $move_uploaded_file_result) {
            $this->_error_message = Message::error(__PMA_TRANSL('Error while moving uploaded file.'));
            return false;
        }
        ...
        if (! $this->isReadable()) {
            $this->_error_message = Message::error(__PMA_TRANSL('Cannot read uploaded file.'));
            return false;
        }
