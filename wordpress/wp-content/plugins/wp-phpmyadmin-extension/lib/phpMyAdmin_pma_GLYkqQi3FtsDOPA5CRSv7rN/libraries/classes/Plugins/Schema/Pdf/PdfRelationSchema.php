...
class PdfRelationSchema extends ExportRelationSchema
{
    ...
    public function __construct($db)
    {
        ...
        $this->diagram->SetTitle(
            sprintf(
                __PMA_TRANSL('Schema of the %s database'),
                $this->db
            )
        );
        ...
        if ($this->_withDoc) {
            ...
            $this->diagram->Bookmark(__PMA_TRANSL('Relational schema'));
    ...
    public function dataDictionaryDoc(array $alltables)
    {
        ...
        $this->diagram->Cell(0, 9, __PMA_TRANSL('Table of contents'), 1, 0, 'C');
        $this->diagram->Ln(15);
        $i = 1;
        foreach ($alltables as $table) {
            ...
            // $this->diagram->Ln(1);
            $this->diagram->Cell(
                0, 6, __PMA_TRANSL('Page number:') . ' {' . sprintf("%02d", $i) . '}', 0, 0,
        ...
        $this->diagram->SetX(10);
        $this->diagram->Cell(
            0, 6, __PMA_TRANSL('Page number:') . ' {00}', 0, 0,
            'R', 0, $this->diagram->PMA_links['RT']['-']
        );
        $this->diagram->SetX(10);
        $this->diagram->Cell(
            0, 6, $i . ' ' . __PMA_TRANSL('Relational schema'), 0, 1,
        ...
        foreach ($alltables as $table) {
            ...
            if (! empty($show_comment)) {
                $this->diagram->Cell(
                    0, 3, __PMA_TRANSL('Table comments:') . ' ' . $show_comment, 0, 1
                );
                $break = true;
            }
            ...
            if (! empty($create_time)) {
                $this->diagram->Cell(
                    0, 3, __PMA_TRANSL('Creation:') . ' ' . $create_time, 0, 1
                );
                $break = true;
            }
            ...
            if (! empty($update_time)) {
                $this->diagram->Cell(
                    0, 3, __PMA_TRANSL('Last update:') . ' ' . $update_time, 0, 1
                );
                $break = true;
            }
            ...
            if (! empty($check_time)) {
                $this->diagram->Cell(
                    0, 3, __PMA_TRANSL('Last check:') . ' ' . $check_time, 0, 1
                );
                $break = true;
            }
            ...
            if (isset($this->orientation) && $this->orientation == 'L') {
                $this->diagram->Cell(25, 8, __PMA_TRANSL('Column'), 1, 0, 'C');
                $this->diagram->Cell(20, 8, __PMA_TRANSL('Type'), 1, 0, 'C');
                $this->diagram->Cell(20, 8, __PMA_TRANSL('Attributes'), 1, 0, 'C');
                $this->diagram->Cell(10, 8, __PMA_TRANSL('Null'), 1, 0, 'C');
                $this->diagram->Cell(20, 8, __PMA_TRANSL('Default'), 1, 0, 'C');
                $this->diagram->Cell(25, 8, __PMA_TRANSL('Extra'), 1, 0, 'C');
                $this->diagram->Cell(45, 8, __PMA_TRANSL('Links to'), 1, 0, 'C');
                ...
                $this->diagram->Cell($comments_width, 8, __PMA_TRANSL('Comments'), 1, 0, 'C');
                $this->diagram->Cell(45, 8, 'MIME', 1, 1, 'C');
                $this->diagram->setWidths(
                    array(25, 20, 20, 10, 20, 25, 45, $comments_width, 45)
                );
            } else {
                $this->diagram->Cell(20, 8, __PMA_TRANSL('Column'), 1, 0, 'C');
                $this->diagram->Cell(20, 8, __PMA_TRANSL('Type'), 1, 0, 'C');
                $this->diagram->Cell(20, 8, __PMA_TRANSL('Attributes'), 1, 0, 'C');
                $this->diagram->Cell(10, 8, __PMA_TRANSL('Null'), 1, 0, 'C');
                $this->diagram->Cell(15, 8, __PMA_TRANSL('Default'), 1, 0, 'C');
                $this->diagram->Cell(15, 8, __PMA_TRANSL('Extra'), 1, 0, 'C');
                $this->diagram->Cell(30, 8, __PMA_TRANSL('Links to'), 1, 0, 'C');
                $this->diagram->Cell(30, 8, __PMA_TRANSL('Comments'), 1, 0, 'C');
