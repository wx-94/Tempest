...
class Pdf extends PdfLib
{
    ...
    public function Header()
    {
        ...
        if (!isset($this->headerset[$this->page])) {
            ...
            $this->Cell(
                0,
                $this->FontSizePt,
                __PMA_TRANSL('Database:') . ' ' . $this->dbAlias . ',  '
                . __PMA_TRANSL('Table:') . ' ' . $this->tableAlias . ',  '
                . __PMA_TRANSL('Purpose:') . ' ' . $this->purpose,
                0,
                1,
                'L'
            );
    ...
    public function getTriggers($db, $table)
    {
         ...
         */
        $this->colTitles[0] = __PMA_TRANSL('Name');
        $this->tablewidths[0] = 90;
        $this->colTitles[1] = __PMA_TRANSL('Time');
        $this->tablewidths[1] = 80;
        $this->colTitles[2] = __PMA_TRANSL('Event');
        $this->tablewidths[2] = 40;
        $this->colTitles[3] = __PMA_TRANSL('Definition');
    ...
    public function getTableDef(
        ...
        $this->colTitles[0] = __PMA_TRANSL('Column');
        $this->tablewidths[0] = 90;
        $this->colTitles[1] = __PMA_TRANSL('Type');
        $this->tablewidths[1] = 80;
        $this->colTitles[2] = __PMA_TRANSL('Null');
        $this->tablewidths[2] = 40;
        $this->colTitles[3] = __PMA_TRANSL('Default');
        ...
        if ($do_relation && $have_rel) {
            $this->colTitles[$columns_cnt] = __PMA_TRANSL('Links to');
            $this->display_column[$columns_cnt] = true;
            $this->colAlign[$columns_cnt] = 'L';
        ...
        if ($do_comments /*&& $cfgRelation['commwork']*/) {
            $this->colTitles[$columns_cnt] = __PMA_TRANSL('Comments');
            $this->display_column[$columns_cnt] = true;
            $this->colAlign[$columns_cnt] = 'L';
            $this->tablewidths[$columns_cnt] = 120;
            $columns_cnt++;
        ...
        if ($do_mime && $cfgRelation['mimework']) {
            $this->colTitles[$columns_cnt] = __PMA_TRANSL('MIME');
            $this->display_column[$columns_cnt] = true;
            $this->colAlign[$columns_cnt] = 'L';
            $this->tablewidths[$columns_cnt] = 120;
            $columns_cnt++;
