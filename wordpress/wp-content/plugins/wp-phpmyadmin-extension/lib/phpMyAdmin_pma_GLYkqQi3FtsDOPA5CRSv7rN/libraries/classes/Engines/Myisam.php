    ...
    public function getVariables()
    {
        return array(
            'myisam_data_pointer_size'        => array(
                'title' => __PMA_TRANSL('Data pointer size'),
                'desc'  => __PMA_TRANSL(
            ...
            'myisam_recover_options'          => array(
                'title' => __PMA_TRANSL('Automatic recovery mode'),
                'desc'  => __PMA_TRANSL(
            ...
            'myisam_max_sort_file_size'       => array(
                'title' => __PMA_TRANSL('Maximum size for temporary sort files'),
                'desc'  => __PMA_TRANSL(
            ...
            'myisam_max_extra_sort_file_size' => array(
                'title' => __PMA_TRANSL('Maximum size for temporary files on index creation'),
                'desc'  => __PMA_TRANSL(
            ...
            'myisam_repair_threads'           => array(
                'title' => __PMA_TRANSL('Repair threads'),
                'desc'  => __PMA_TRANSL(
            ...
            'myisam_sort_buffer_size'         => array(
                'title' => __PMA_TRANSL('Sort buffer size'),
                'desc'  => __PMA_TRANSL(
