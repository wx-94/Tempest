...
<h2><?php echo __PMA_TRANSL('Available MIME types'); ?></h2>
<?php
...
$label = array(
    'transformation' => __PMA_TRANSL('Available browser display transformations'),
    'input_transformation' => __PMA_TRANSL('Available input transformations')
);
$th = array(
    'transformation' => __PMA_TRANSL('Browser display transformation'),
    'input_transformation' => __PMA_TRANSL('Input transformation')
);
?>
<br />
