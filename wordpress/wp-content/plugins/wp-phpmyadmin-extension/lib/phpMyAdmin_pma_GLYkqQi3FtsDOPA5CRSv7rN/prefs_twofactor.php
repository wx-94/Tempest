...
if (isset($_POST['2fa_remove'])) {
    if (! $two_factor->check(true)) {
        ...
        Message::rawNotice(__PMA_TRANSL('Two-factor authentication has been removed.'))->display();
    }
    ...
    if (! $two_factor->configure($_POST['2fa_configure'])) {
        ...
        Message::rawNotice(__PMA_TRANSL('Two-factor authentication has been configured.'))->display();
    }
}
